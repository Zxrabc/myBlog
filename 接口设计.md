...
博客相关接口
    ...
    删除指定博客(可批量删除，参数为博客id数组)
        url:127.0.0.1:8080/blog/delete
        method:post
        data:[string]
        <!-- 删除成功返回：code:200,data:true,失败返回：code:999,data:false -->
        return:{
            code:number,
            message:string,
            data:boolean
    ...
    更新指定博客
        ...
        <!-- 更新成功返回：code:200,data:true,失败返回：code:999,data:false -->
        return:{
            code:number,
            message:string,
            data:boolean
    ...
    发布博客(id通过后端自动生成uuid确保唯一性)
        ...
        <!-- 发布成功返回：code:200,data:true,失败返回：code:999,data:false -->
        return:{
            code:number,
            message:string,
            data:boolean
...
标签相关接口
    ...
    修改标签
        ...
        <!-- 修改成功返回：code:200,data:true,失败返回：code:999,data:false -->
        return:{
            code:number,
            message:string,
            data:boolean
    ...
    删除标签(可批量删除，参数为标签id数组)
        url:127.0.0.1:8080/tag/delete
        method:post
        data:[string]
        <!-- 删除成功返回：code:200,data:true,标签被使用删除失败返回：code:998,data:tagname,其他原因删除失败返回：code:999,data:false -->
        return:{
            code:number,
            message:string,
            data:boolean
    ...
    添加标签
        ...
        method:post
        data:tagname:string
        <!-- 添加成功返回：code:200,data:true,标签名重复添加失败返回：code:997,data:false,其他原因添加失败返回：code:999,data:false -->
        return:{
            code:number,
            message:string,
            data:boolean
...
分类相关接口
    ...
    根据分类名查询分类ID
        url:127.0.0.1:8080/category/getId
        method:post
        data:{
            categoryname:string
        }
    ...
    添加分类
        ...
        <!-- 添加成功返回：code:200,data:true,分类名重复添加失败返回：code:997,data:false,其他原因添加失败返回：code:999,data:false -->
        return:{
            code:number,
            message:string,
            data:boolean
